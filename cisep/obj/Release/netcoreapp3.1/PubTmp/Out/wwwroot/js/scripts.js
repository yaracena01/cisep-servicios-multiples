...
(function($) {
	...
	$(function() {
        $(document).on('click', 'a.page-scroll', function (event) {
            var $anchor = $(this);      
            console.log(typeof $($anchor.attr('href')).offset() != 'undefined');
    ...
    /* Contact Form */
 //   $("#emailContact").validator().on("submit", function(event) {
 //   	if (event.isDefaultPrevented()) {
 //           // handle the invalid form...
 //           cformError();
 ...
 //   }
    ...
    $(window).scroll(function () {
        ...
        if ($(window).scrollTop() > servicesAnimation) {     
